...
"""1.1 给出匹配浮点数字符串的正则表达式 """
text1 = "+234 12.32 -422.3 -0.892"
pattern1 = "[\d.\d]+"
matches1 = re.findall(pattern1, text1)
print("Solution for question 1.1: ", matches1)
print("-" * 50)
"""-------------------------------------------------------------------"""

"""1.2 给出匹配所有邮箱的正则表达式"""
text2 = "edison@163.com 2134123123@qq.com wuuuuwu2022@gmail.com mr.jack@gmail.com J.Doe@company.tech"
pattern2 = "\S+@\S+\.\S+"
matches2 = re.findall(pattern2, text2)
print("Solution for question 1.2: ", matches2)
print("-" * 50)

"""-------------------------------------------------------------------"""

"""2. 请算出下列4个文档中每一个单词的TF-IDF"""
corpus1 = [
